...
export const routes: Routes = [
  ...
  {path: 'sidebar-admin', component: SidebarAdmin, canActivate: [adminGuard] },
  {path: 'config-admin', component: ConfigAdminComponent, canActivate: [adminGuard] },
  {path: 'mapa-reportes', component: MapaReportesComponent, canActivate: [adminGuard] },
  { path: 'admin', component: Admin, canActivate: [adminGuard] },
  {path: 'senales', component: SenalesComponent, canActivate: [authGuard] },
  ...
  {path: 'voice-chat-bot', component: VoiceChatBotComponent, canActivate: [authGuard] },
